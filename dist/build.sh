...
#echo "debug found"
LC_ALL=C.UTF-8 find * -mindepth 0 -name "rootfs" -printf '%P\0' | LC_ALL=C.UTF-8 sort -z | LC_ALL=C.UTF-8 bsdtar --uid 0 --gid 0 --null -cnf - -T - | LC_ALL=C.UTF-8 bsdtar --null -cf - --format=newc @- | zstd >> /dist/rootfs.img
popd
